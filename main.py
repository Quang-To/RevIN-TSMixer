"""
RevINMixer: Time Series Forecasting with Inventory Cost Optimization

Training Strategy:
- Training always uses MAPE loss for forecast accuracy
- Validation uses sweep_tc for inventory cost optimization or MAPE for accuracy
"""
